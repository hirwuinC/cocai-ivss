<?php
	...
	class sessionModel extends Model {
		...
		public function getRole($id) {
				//echo $id;
			$this->_query = "SELECT usuario.id, usuario.nombre as 'name', usuario.apellido, unidad_negocio.id as 'idUd', unidad_negocio.codigo, unidad_negocio.nombre as 'tienda', modelo.id as 'idM', modelo.nombre as 'modelo', referencia.referencia as perfil 
				FROM `usuario` 
