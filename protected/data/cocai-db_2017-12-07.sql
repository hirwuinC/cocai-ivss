...
(1, 'A001', '', 'Arroz', 'Primor', '1000.00', 990, 24, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, NULL, NULL, NULL, NULL),
(2, 'B002', '', 'Refresco', 'Coca-cola', '3000.00', 2000, 12, 'Cja * 2000', 'Ltrs *', 'Ml *', 117, 11, 4, 12, NULL, NULL, NULL, NULL),
(3, 'AT001', NULL, 'Atun', 'Eveba', '1500.00', 600, 24, 'Cja * 600', NULL, NULL, 116, 11, 15, 6, NULL, NULL, NULL, NULL),
(4, 'AC001', NULL, 'Aceite', 'Vatel', '5000.00', 1000, 12, 'Cja * 1000', NULL, NULL, 116, 11, 4, 12, NULL, NULL, NULL, NULL),
(6, 'Q0010', '', 'Queso amarillo', 'Paisa', '10000.00', 600, 12, 'Cja * 600', NULL, NULL, 116, 11, 5, 6, NULL, NULL, NULL, NULL),
(7, 'H0012', '', 'Harina', 'Pan', '8000.00', 990, 24, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, NULL, NULL, NULL, NULL),
(8, 'J0041', NULL, 'Jamon', 'Plumrose', '50000.00', 25000, 1, 'Pza * 2500', '', '', 116, 14, 5, 6, NULL, NULL, NULL, NULL),
(9, '59006', NULL, 'Agua saborizada', 'Los andes', '1000.00', 700, 24, 'Cja * 700', NULL, NULL, 117, 11, 7, 12, NULL, NULL, 1, NULL),
(11, '59007', 'abcd', 'harina', 'juana', '40000.00', 1000, 24, 'Blto * 1000', 'Kgs *', 'Gr *', 116, 19, 5, 6, 1000, 'harina de maiz', 1, 1000),
(12, '59007', 'abcd', 'arroz', 'mary', '40.00', 990, 3, 'Blto * 990', NULL, 'null', 116, 19, 5, 6, 1000, 'arroz mary 1 kg', 0, 1000),
(13, '59008', 'p003', 'Refresco', 'refresco pepsi de 1 litro', '50.00', 1000, 9, 'Cja * 9', 'null', 'null', 117, 11, 4, 12, NULL, NULL, NULL, NULL),
(14, '59009', 'null', 'pasta', 'primor', '40.00', 1000, 2, 'Kgs * 1000', 'null', 'null', 116, 5, 5, 6, 1000, 'probando', 0, 1000),
(15, '590010', '', 'Refresco', 'Sevenup', '50000.00', 2000, 3, 'Cja * 2000', 'null', 'null', 117, 11, 4, 12, NULL, NULL, NULL, NULL),
(16, '590010', 'null', 'Atun', 'Margarita', '35000.00', 500, 2, 'Lta * 500', 'null', 'null', 116, 15, 15, 6, 450, 'atun enlatado margarita 500gr', 0, 500),
(17, '590011', 'null', 'salsa', 'ketchup', '2000.00', 250, 20, 'Ltrs * 250', 'null', 'null', 116, 4, 4, 12, 250, 'prueba precio proveedor', 0, 250),
(18, '590012', 'null', 'azucar', 'la lucha', '25000.00', 1000, 2, 'Kgs * 1000', 'null', 'null', 116, 5, 5, 6, 1000, 'probando', 0, 1000),
(19, '590013', '', 'asdas', 'sadasd', '2121.22', 22222, 2, 'Kgs * 22222', '', '', 116, 5, 5, 6, 1111, '', 0, 22222),
(20, '590014', '', 'fdsfsdf', 'asdasd', '213.32', 21312, 2, 'Kgs * 21312', '', '', 116, 5, 16, 12, 21312, '', 0, 21321);
...
INSERT INTO `mercancia_has_reposicion` (`id`, `cantidad`, `precio`, `ingrediente_id`, `unidad_medida_id`, `proveedor_id`) VALUES
(25, 2, '3000', 2, 0, NULL),
(35, 2, '3000', 2, 0, NULL),
(36, 2, '3000', 2, 0, NULL),
(38, 2, '3000', 2, 0, NULL),
...
ALTER TABLE `mercancia_has_reposicion`
 ADD PRIMARY KEY (`id`), ADD KEY `ingrediente_id` (`ingrediente_id`), ADD KEY `unidad_medida_id` (`unidad_medida_id`), ADD KEY `proveedor_id` (`proveedor_id`), ADD KEY `unidad_medida_id_2` (`unidad_medida_id`);
