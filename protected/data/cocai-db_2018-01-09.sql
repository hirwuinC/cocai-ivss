...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 09, 2018 at 09:06 AM
...
(1, '2018-01-08', '2018-01-08', 'POSTRES', 'FPSAU9100001', 'Brownie', 2, '9607.1428', '100.0000', '0.0000', '0.0000', '0.0000', 1),
(2, '2018-01-08', '2018-01-08', 'BEBIDAS 16 Oz', 'FPSAU8300004', 'Pepsi Cola 16 Oz', 5, '13616.0715', '83.3300', '0.0000', '0.0000', '0.0000', 1),
(3, '2018-01-08', '2018-01-08', 'POSTRES', 'FPSAU9100001', 'Brownie', 2, '9607.1428', '100.0000', '0.0000', '0.0000', '0.0000', 1),
(4, '2018-01-08', '2018-01-08', 'BEBIDAS 16 Oz', 'FPSAU8300004', 'Pepsi Cola 16 Oz', 5, '13616.0715', '83.3300', '0.0000', '0.0000', '0.0000', 1);
...
`id` int(11) NOT NULL,
  ...
  `rendimiento` decimal(19,4) DEFAULT '0.0000',
...
(1, 'A001', '', 'Arroz', 'Primor', '1000.0000', '990.0000', 24, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, NULL, NULL, NULL, NULL, 18),
(2, 'B002', '', 'Refresco', 'Coca-cola', '35000.0000', '2000.0000', 12, 'Cja * 2000', 'Ltrs *', 'Ml *', 117, 11, 4, 12, NULL, NULL, NULL, NULL, 12),
(4, 'AC001', NULL, 'Aceite', 'Vatel', '12000.0000', '1000.0000', 12, 'Cja * 1000', NULL, NULL, 116, 11, 4, 12, NULL, NULL, NULL, NULL, 15),
(6, 'Q0010', '', 'Queso', 'Mozarella', '10000.0000', '600.0000', 12, 'Cja * 600', NULL, NULL, 116, 11, 5, 6, NULL, NULL, NULL, NULL, NULL),
(7, 'H0012', '', 'Harina', 'Pan', '8000.0000', '990.0000', 24, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, NULL, NULL, NULL, NULL, NULL),
(8, 'J0041', NULL, 'Jamon', 'Plumrose', '50000.0000', '25000.0000', 1, 'Pza * 2500', '', '', 116, 14, 5, 6, NULL, NULL, NULL, NULL, NULL),
(9, '59006', NULL, 'Agua saborizada', 'Los andes', '1000.0000', '700.0000', 24, 'Cja * 700', NULL, NULL, 117, 11, 7, 12, NULL, NULL, 1, NULL, NULL),
(11, '59007', 'abcd', 'harina', 'juana', '40000.0000', '1000.0000', 24, 'Blto * 1000', 'Kgs *', 'Gr *', 116, 19, 5, 6, '1000.0000', 'harina de maiz', 1, '1000.0000', NULL),
(12, '59007', 'abcd', 'arroz', 'mary', '4000.0000', '990.0000', 3, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, '1000.0000', 'arroz mary 1 kg', 0, '1000.0000', NULL),
(13, '59008', 'p003', 'Refresco', 'refresco pepsi de 1 litro', '50.0000', '1000.0000', 9, 'Cja * 9', 'null', 'null', 117, 11, 4, 12, NULL, NULL, NULL, NULL, NULL),
(14, '59009', 'null', 'pasta', 'primor', '40.0000', '1000.0000', 2, 'Kgs * 1000', 'null', 'null', 116, 5, 5, 6, '1000.0000', 'probando', 0, '1000.0000', NULL),
(15, '5900101', '', 'Refresco', 'Sevenup', '50000.0000', '2000.0000', 3, 'Cja * 2000', 'null', 'null', 117, 11, 4, 12, NULL, NULL, NULL, NULL, NULL),
(16, '590010', 'null', 'Atun', 'Margarita', '3000.0000', '500.0000', 2, 'Lta * 500', 'null', 'null', 116, 15, 15, 6, '450.0000', 'atun enlatado margarita 500gr', 0, '500.0000', 13),
(17, '590011', 'null', 'salsa', 'ketchup', '2000.0000', '250.0000', 20, 'Ltrs * 250', 'null', 'null', 116, 4, 4, 12, '250.0000', 'prueba precio proveedor', 0, '250.0000', NULL),
(18, '590012', 'null', 'azucar', 'la lucha', '25000.0000', '1000.0000', 2, 'Kgs * 1000', 'null', 'null', 116, 5, 5, 6, '1000.0000', 'probando', 0, '1000.0000', NULL),
(19, '590013', '', 'asdas', 'sadasd', '2121.2200', '22222.0000', 2, 'Kgs * 22222', '', '', 116, 5, 5, 6, '1111.0000', '', 0, '22222.0000', NULL),
(20, '590014', '', 'fdsfsdf', 'asdasd', '213.3200', '21312.0000', 2, 'Kgs * 21312', '', '', 116, 5, 16, 12, '21312.0000', '', 0, '21321.0000', NULL),
(21, 'BRI001', '', 'Brownie', 'Savoy', '2000.0000', '600.0000', 12, 'Cja * 600', 'Un *', 'Un *', 116, 11, 29, 13, NULL, NULL, NULL, NULL, NULL),
(22, 'CM001', '', 'Caramelos', 'Menta', '1000.0000', '1.0000', 24, 'Cja * 1', 'Gr *', 'Gr *', 116, 11, 6, 6, NULL, NULL, NULL, NULL, NULL),
(23, 'CC001', '', 'Cucharitas', 'de postre', '1000.0000', '20.0000', 24, 'Pqte * 20', 'Un *', 'Un *', 119, 16, 13, 13, NULL, NULL, NULL, NULL, NULL),
(24, 'SVZ001', '', 'Servilletas z', 'Paveca', '5000.0000', '100.0000', 100, 'Pqte * 100', 'Un *', 'Un *', 119, 16, 13, 13, NULL, NULL, NULL, NULL, NULL),
(26, 'AL001', '', 'Albahaca', 'Natural', '1000.0000', '990.0000', 24, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, NULL, NULL, NULL, NULL, NULL),
(27, 'TM001', '', 'Tomate', 'Natural', '700.0000', '1.0000', 1, 'Blto * 1', 'Kgs *', 'Gr *', 116, 9, 6, 6, NULL, NULL, NULL, NULL, NULL),
(28, 'CP001', '', 'Cuchillos', 'Plasticos', '6000.0000', '100.0000', 100, 'Pqte * 100', 'Un *', 'Un *', 119, 16, 13, 13, NULL, NULL, NULL, NULL, NULL),
(29, 'ADC001', '', 'Aderezo', 'Caprese', '1000.0000', '990.0000', 24, 'Caja * 990', 'Ltr *', 'Ml *', 116, 11, 4, 12, NULL, NULL, NULL, NULL, NULL),
(30, 'TND001', '', 'Tenedores', 'Plasticos', '6000.0000', '100.0000', 100, 'Pqte * 100', 'Un *', 'Un *', 119, 16, 13, 13, NULL, NULL, NULL, NULL, NULL),
(31, '5900121', '', 'arroz', 'casa', '2000.0000', '1000.0000', 3, 'Kgs * 1000', '', '', 116, 5, 5, 6, '1100.0000', 'arroz prueba', 0, '1000.0000', NULL),
(32, '590021', '', 'probadita', 'wasa', '2000.0000', '2112.0000', 10, 'Cja * 2112', '', '', 116, 11, 5, 6, NULL, NULL, NULL, NULL, NULL);
...
(1, 'FPSAU8700004', 'FPSAU8700004', 'Piz. Manhattan 12', '88000.0000', '246.9100', '35640.0000', '26360.7100', '0.0000', 0, 0, 0, '0', 1, 1),
(2, 'FPSAU8800004', 'FPSAU8800004', 'Piz. Manhattan 16', '54000.0000', '121.3800', '44490.0000', '32901.7900', '0.0000', 0, 0, 0, '0', 2, 2),
(3, 'FPSAU9100001', NULL, 'Brownie', '9000.0000', '20.0000', '45000.0000', '37000.0000', '0.0000', 0, 0, 0, '0', 3, 16),
(4, 'FPSAU8300004', NULL, 'Pepsi Cola 16 Oz', '39000.0000', '69.6429', '56000.0000', '48000.0000', '0.0000', 0, 0, 0, '0', 4, 17),
(5, 'FPSE0001118', NULL, 'Ensalada Capresa', '25700.0000', '128.5000', '60000.0000', '17000.0000', '0.0000', 0, 0, 0, '0', 5, NULL);
...
(1, 'pizza manhattan 12', '15000.0000'),
(2, 'Piz. Manhattan 16', NULL),
(3, 'salsa de tomate', '2000.0000'),
...
(16, 'Brownie', '2000.0000'),
(17, 'Pepsi Cola 16 Oz', '50000.0000'),
...
ALTER TABLE `explosion`
 ADD PRIMARY KEY (`id`), ADD KEY `grupo_id` (`grupo`), ADD KEY `producto_id` (`producto`), ADD KEY `unidad_negocio_id` (`unidad_negocio_id`);
...
ALTER TABLE `mercancia`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_mercancia_referencia1_idx` (`familia_id`), ADD KEY `fk_mercancia_unidad_medida1_idx` (`unidad_medida_compra_id`), ADD KEY `fk_mercancia_unidad_medida2_idx` (`unidad_medida_consumo_id`), ADD KEY `fk_mercancia_unidad_medida3_idx` (`unidad_medida_sistema_id`), ADD KEY `receta_id` (`receta_id`);

--
-- Indexes for table `mercancia_has_reposicion`
--
ALTER TABLE `mercancia_has_reposicion`
 ADD PRIMARY KEY (`id`), ADD KEY `ingrediente_id` (`ingrediente_id`), ADD KEY `unidad_medida_id` (`unidad_medida_id`), ADD KEY `proveedor_id` (`proveedor_id`), ADD KEY `unidad_medida_id_2` (`unidad_medida_id`), ADD KEY `reposicion_id` (`reposicion_id`);
...
ALTER TABLE `reposicion_mercancia`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_carga_compra_unidad_negocio1_idx` (`unidad_negocio_id`), ADD KEY `fk_carga_compra_usuario1_idx` (`usuario_id`);
