...
`id` int(11) NOT NULL,
  ...
  `descripcion` text,
  `exento_inpuesto` tinyint(1) DEFAULT NULL,
...
INSERT INTO `mercancia` (`id`, `codigo`, `codigo_anterior`, `nombre`, `marca`, `precio_unitario`, `contenido_neto`, `cantidad_presentacion`, `formula_c`, `formula_p`, `formula_s`, `familia_id`, `unidad_medida_compra_id`, `unidad_medida_consumo_id`, `unidad_medida_sistema_id`, `peso_escurrido`, `descripcion`, `exento_inpuesto`, `rendimiento`) VALUES
(1, 'A001', '', 'Arroz', 'Primor', '1.000,00', 990, 24, 'Blto * 990', 'Kgs *', 'Gr *', 116, 19, 5, 6, NULL, NULL, NULL, NULL),
(2, 'B002', NULL, 'Refresco', 'Coca-cola', '3.000,00', 2000, 12, '', NULL, NULL, 117, 11, 4, 12, NULL, NULL, NULL, NULL),
(3, 'AT001', NULL, 'Atun', 'Eveba', '1.500,00', 600, 24, '', NULL, NULL, 116, 11, 15, 6, NULL, NULL, NULL, NULL),
(4, 'AC001', NULL, 'Aceite', 'Vatel', '5.000,00', 1000, 12, '', NULL, NULL, 116, 11, 4, 12, NULL, NULL, NULL, NULL),
...
(1, 1, NULL, 60000, 5000, 10000, 0, NULL),
(1, 3, NULL, 60000, 5000, 10000, 0, NULL),
(1, 5, NULL, 100000, 2000, 16500, 0, NULL),
(1, 7, NULL, 100000, 14000, 26000, 0, NULL),
(1, 59, NULL, 71280, 10000, 30000, 0, NULL),
(2, 1, NULL, 8500, 6000, 9000, 0, NULL),
(2, 59, NULL, 50, 30, 60, 0, NULL),
(3, 39, NULL, 5000, 4000, 8000, 0, NULL),
(3, 59, NULL, 10000, 8000, 12000, 0, NULL),
(4, 39, NULL, 4500, 3000, 6000, 0, NULL),
(4, 59, NULL, 13000, 10000, 16000, 0, NULL),
(6, 59, NULL, 7200, 5000, 10000, 0, NULL),
(9, 59, NULL, 33600, 50, 100, 1, '');
...
(2, 'FPSAU8800004', 'FPSAU8800004', 'Piz. Manhattan 16', '0,00', '44.490,00', '32.901,79', 0, 0, 0, '0', 20, 30, 40, 2, NULL);
