...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 15, 2017 at 01:25 PM
...
ALTER TABLE `explosion`
 ADD PRIMARY KEY (`id`), ADD KEY `grupo_id` (`grupo_id`), ADD KEY `producto_id` (`producto_id`);
...
ALTER TABLE `ingredientes_has_explosion`
 ADD KEY `explosion_id` (`explosion_id`,`ingrediente_id`,`unidad_medida_id`);
